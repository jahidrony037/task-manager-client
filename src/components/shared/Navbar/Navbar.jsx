          ...
          <div className="hidden lg:flex flex-none">
            ...
            {user ? (
              <div className="dropdown dropdown-end ml-4">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="avatar placeholder">
                      <div className="bg-linear-to-br from-yellow-400 to-orange-500 text-white rounded-full w-10 h-10 ring-2 ring-white shadow-xl flex items-center justify-center">
                ...
                >
                  <li className="menu-title px-4 py-2">
                    <div className="flex items-center gap-3">
                      <div className="avatar placeholder">
                        <div className="bg-linear-to-br from-yellow-400 to-orange-500 text-white rounded-full w-12 h-12 shadow-lg">
              ...
              <div className="flex items-center">
                <Link
                  to="/login"
                  className="font-semibold bg-white/20 p-3 rounded-3xl"
                >
                  Login
                </Link>
              </div>
